...
{
    partial class EditWalletSettingsForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "DENY_INCOME_TRANSFERS_WITH_\r\nAMOUNT_LESS_THAN:";
			// 
			// textBox1
			// 
			...
			this.Name = "EditWalletSettingsForm";
			this.ShowIcon = false;
			this.Text = "EDIT_WALLET_SETTINGS";
			this.Shown += new System.EventHandler(this.EditWalletSettingsForm_Shown);
